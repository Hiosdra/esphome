...
class ImprovThreadComponent : public Component, public improv_base::ImprovBase {
 public:
  ImprovThreadComponent();
  ...
  void set_thread_timeout(uint32_t thread_timeout) { this->thread_timeout_ = thread_timeout; }
  uint32_t get_thread_timeout() const { return this->thread_timeout_; }
 ...
 protected:
  ...
  uint32_t thread_timeout_{};

  std::vector<uint8_t> incoming_data_;
  std::vector<uint8_t> thread_dataset_;
  ...
  void on_thread_connect_timeout_();
  void check_thread_connection_();
...
extern ImprovThreadComponent *global_improv_thread_component;
