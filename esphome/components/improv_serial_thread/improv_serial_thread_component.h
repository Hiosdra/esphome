...
class ImprovSerialThreadComponent : public Component, public improv_base::ImprovBase {
 public:
  void setup() override;
  void loop() override;
...
extern ImprovSerialThreadComponent
    *global_improv_serial_thread_component;  // NOLINT(cppcoreguidelines-avoid-non-const-global-variables)
