...
class ESP32ImprovThreadComponent : public Component, public improv_base::ImprovBase {
 public:
  ESP32ImprovThreadComponent();
 ...
 protected:
  ...
  std::vector<uint8_t> dataset_tlv_;
...
extern ESP32ImprovThreadComponent *global_improv_thread_component;
